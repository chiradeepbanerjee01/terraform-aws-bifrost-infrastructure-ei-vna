...
module "waf" {
  source = "git@github.com:HylandSoftware/terraform-aws-delivery-infra-service-catalog.git//aws_security_wafv2?ref=3.0.0"
  depends_on = [ module.waf_log_group ]
}

module "sns" {
  source = "git@github.com:HylandSoftware/terraform-aws-delivery-infra-service-catalog.git//aws_observability_sns_topic"
}
